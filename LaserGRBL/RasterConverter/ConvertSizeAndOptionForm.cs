...
namespace LaserGRBL.RasterConverter
{
	...
	public partial class ConvertSizeAndOptionForm : Form
	{
		...
		public void ShowDialog(ImageProcessor processor)
		{
			...
			IILinearFilling.Enabled = LblLinearFilling.Enabled = LblLinearFillingmm.Enabled = (IP.SelectedTool == ImageProcessor.Tool.Line2Line || IP.SelectedTool == ImageProcessor.Tool.Dithering || (IP.SelectedTool == ImageProcessor.Tool.Vectorize && (IP.FillingDirection != ImageProcessor.Direction.None)));
			IIBorderTracing.Enabled = LblBorderTracing.Enabled = LblBorderTracingmm.Enabled = (IP.SelectedTool == ImageProcessor.Tool.Vectorize);
